...
export function PanelMesh({
  ...
  // Hide face hardware until its step so carcase/shelf photos look into the open bay.
  if (hasStep && !inStep && (isDoor || isDrawer)) return null;
  // Progressive PDF: doors swing only on hang/door steps — not confirm/cut/carcase.
