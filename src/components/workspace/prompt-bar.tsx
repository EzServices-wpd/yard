    ...
    <div className="shrink-0 border-b border-border bg-surface px-3 py-3 sm:px-4">
      ...
      >
        <input
          ...
          className="h-11 flex-1 rounded-md border border-border bg-bg px-3 text-sm text-fg outline-none ring-fg/15 placeholder:text-faint focus:ring-2"
        />
        <button
          type="submit"
          disabled={grokBusy}
          className="inline-flex h-11 items-center justify-center gap-2 rounded-md bg-accent px-4 text-sm font-medium text-accent-fg disabled:opacity-60"
        >
