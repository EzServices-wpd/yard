...
export const SHOP_GLOSSARY: { term: string; def: string }[] = [
  ...
  { term: "Rack / racking", def: "Twisting the box out of square. A racked main box makes doors and drawers bind." },
  ...
  { term: "Concealed hinges", def: "Cup hinges that mount inside the door and main box so you do not see the hinge from the front." },
