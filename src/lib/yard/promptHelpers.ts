...
export function weekendSizedStockPhrases(): [RegExp, string][] {
  return [
    ...
    [/2\s*[x×]\s*12\s*[x×]\s*10|2x12x10|2\s*[x×]\s*12.{0,12}10\s*(?:ft|foot|feet)/, "lumber-2x12-10"],
    [/2\s*[x×]\s*12|2x12/, "lumber-2x12-8"],
    [/2\s*[x×]\s*10\s*[x×]\s*10|2x10x10|2\s*[x×]\s*10.{0,12}10\s*(?:ft|foot|feet)/, "lumber-2x10-10"],
