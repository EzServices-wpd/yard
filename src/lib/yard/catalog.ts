...
export const FORGE_CATALOG: CatalogItem[] = [
  ...
  },
  {
    ...
    unitsPerPack: 1,
    unitCostUsd: 4.0,
    aliases: catalogLumberAliases(["1x4", "one by four"]),
    tags: catalogLumberTags(["lumber", "trim", "shelf"]),
  ...
  },
  {
    ...
    category: "lumber",
    formFactor: "board",
    dims: { length: 96, width: 1.5, height: 0.75 },
    unitsPerPack: 1,
    unitCostUsd: 2.48,
    aliases: ["1x2", "one by two", "1×2"],
    tags: ["lumber", "trim", "furring"],
    preferredJoins: ["screw", "nail", "glue"],
    canCut: true,
    color: "#e0d0b0",
    searchQuery: "1x2x8 pine board",
  },
  {
    id: "lumber-1x3-8",
    name: "1×3 Board (8 ft)",
    category: "lumber",
    formFactor: "board",
    dims: { length: 96, width: 2.5, height: 0.75 },
    unitsPerPack: 1,
    unitCostUsd: 3.28,
    aliases: ["1x3", "one by three", "1×3"],
    tags: ["lumber", "trim"],
    preferredJoins: ["screw", "nail", "glue"],
    canCut: true,
    color: "#e0d0b0",
    searchQuery: "1x3x8 pine board",
  },
  {
    id: "lumber-2x4-8",
    name: "2×4 Stud (8 ft)",
  ...
  },
  {
    ...
    category: "lumber",
    formFactor: "board",
    dims: { length: 96, width: 11.25, height: 1.5 },
    unitsPerPack: 1,
    unitCostUsd: 22,
    aliases: ["2x12", "two by twelve"],
    tags: ["lumber", "framing", "header"],
    preferredJoins: ["nail", "screw"],
    canCut: true,
    color: "#d8c4a0",
    roughness: 0.75,
    searchQuery: "2x12x8 framing lumber",
  },
  {
    id: "lumber-2x10-10",
    name: "2×10 (10 ft)",
    ...
    category: "lumber",
    formFactor: "board",
    dims: { length: 120, width: 9.25, height: 1.5 },
    unitsPerPack: 1,
    unitCostUsd: 24,
    aliases: ["2x10x10", "ten foot 2x10"],
    tags: ["lumber", "framing", "header"],
    preferredJoins: ["nail", "screw"],
    canCut: true,
    color: "#d8c4a0",
    roughness: 0.75,
    searchQuery: "2x10x10 framing lumber",
  },
  {
    id: "lumber-2x12-10",
    name: "2×12 (10 ft)",
    ...
    category: "lumber",
    formFactor: "board",
    dims: { length: 120, width: 11.25, height: 1.5 },
    unitsPerPack: 1,
    unitCostUsd: 32,
    aliases: ["2x12x10", "ten foot 2x12"],
    tags: ["lumber", "framing", "header"],
    preferredJoins: ["nail", "screw"],
    canCut: true,
    color: "#d8c4a0",
    roughness: 0.75,
    searchQuery: "2x12x10 framing lumber",
  },
  {
    id: "plywood-1-2-4x8",
    name: '1/2" Plywood 4×8',
    category: "sheet_goods",
    formFactor: "sheet",
    dims: { length: 96, width: 48, thickness: 0.5 },
    unitsPerPack: 1,
    unitCostUsd: 42,
    aliases: ["1/2 plywood", "half inch plywood", "header spacer"],
    tags: ["sheet", "framing", "header"],
    preferredJoins: ["nail", "screw", "glue"],
    canCut: true,
    color: "#d4a574",
    roughness: 0.65,
  ...
  },
  {
    ...
    category: "other",
    formFactor: "board",
    dims: { length: 80, width: 36, thickness: 1.375 },
    unitsPerPack: 1,
    unitCostUsd: 189,
    aliases: ["prehung door", "interior door", "exterior door", "entry door", "french door"],
    tags: ["door", "opening", "framing"],
    preferredJoins: ["screw", "nail"],
    canCut: false,
    color: "#c4a574",
    roughness: 0.55,
    searchQuery: "36x80 prehung interior door",
    notes: "Slab size is the door you buy. Rough opening is typically 2\" wider and 2½\" taller. Confirm the shop drawing.",
  },
  {
    id: "lumber-4x4-8",
    name: "4×4 Post (8 ft)",
    ...
    tags: ["lumber", "post", "leg"],
    preferredJoins: ["screw", "nail"],
    canCut: true,
    color: "#c4a574",
    roughness: 0.78,
    searchQuery: "4x4x8 pressure treated or fir post",
  },
  {
    id: "closet-rod",
    name: 'Closet rod 1-1/4" (8 ft)',
    category: "lumber",
    formFactor: "dowel",
    dims: { length: 96, diameter: 1.25 },
    unitsPerPack: 1,
    unitCostUsd: 14,
    aliases: ["closet rod", "closet pole", "hanging rod"],
    tags: ["closet", "rod", "hardware"],
    preferredJoins: ["screw"],
    canCut: true,
    color: "#d8d2c8",
    roughness: 0.4,
    metalness: 0.35,
    searchQuery: "1-1/4 inch closet rod 8 ft",
    notes: "Cut to the bay. One 8 ft rod covers several short bays. Sockets are separate.",
  },
  {
    id: "lumber-2x2-8",
    name: "2×2 (8 ft)",
  ...
  {
    id: "plywood-1-4-4x8",
    name: '1/4" Plywood 4×8',
    category: "sheet_goods",
    formFactor: "sheet",
    dims: { length: 96, width: 48, thickness: 0.25 },
    unitsPerPack: 1,
    unitCostUsd: 24.98,
    aliases: ["1/4 plywood", "quarter inch plywood", "backer plywood", "thin backer"],
    tags: ["sheet", "cabinet", "backer"],
    preferredJoins: ["screw", "glue", "staple"],
    canCut: true,
    color: "#d4a574",
    roughness: 0.65,
    searchQuery: "1/4 inch 4x8 plywood",
  },
  {
    id: "plywood-1-4-4x10",
    name: '1/4" Plywood 4×10',
    category: "sheet_goods",
    formFactor: "sheet",
    dims: { length: 120, width: 48, thickness: 0.25 },
    unitsPerPack: 1,
    unitCostUsd: 34.98,
    aliases: ["1/4 plywood 4x10", "quarter inch 4x10", "tall backer plywood", "ten foot backer"],
    tags: ["sheet", "cabinet", "backer", "tall"],
    preferredJoins: ["screw", "glue", "staple"],
    canCut: true,
    color: "#d4a574",
    roughness: 0.65,
    searchQuery: "1/4 inch 4x10 plywood",
  },
  {
    id: "plywood-3-4-4x10",
    name: '3/4" Plywood 4×10',
    category: "sheet_goods",
    formFactor: "sheet",
    dims: { length: 120, width: 48, thickness: 0.75 },
    unitsPerPack: 1,
    unitCostUsd: 72,
    aliases: ["3/4 plywood 4x10", "4x10 plywood", "ten foot plywood"],
    tags: ["sheet", "cabinet", "furniture", "tall"],
    preferredJoins: ["screw", "glue", "notch"],
    canCut: true,
    color: "#d4a574",
    roughness: 0.65,
    searchQuery: "3/4 inch 4x10 plywood",
  },
  {
    id: "toothpick",
  ...
  },
  {
    ...
    category: "hardware",
    formFactor: "roll",
    dims: { length: 300, width: 0.8125, thickness: 0.02 },
    unitsPerPack: 1,
    unitCostUsd: 8.98,
    aliases: ["edge banding", "iron on edge banding", "veneer edge banding", "plywood edge band"],
    tags: ["hardware", "finish", "plywood"],
    preferredJoins: ["glue"],
    canCut: true,
    color: "#d4b896",
    searchQuery: "iron on edge banding birch 3/4 inch",
    notes: "Thin veneer roll ironed onto raw plywood edges people will see.",
  },
  {
    id: "glue",
    name: "Wood glue",
