...
export const FORGE_CATALOG: CatalogItem[] = [
  ...
  },
  {
    ...
    unitsPerPack: 1,
    unitCostUsd: 4.0,
    aliases: ["1x4", "one by four", "cedar", "cedar 1x4", "cedar board", "pine", "pine 1x4", "pine board", "balsa", "balsa 1x4", "balsa board", "maple", "maple 1x4", "maple board", "walnut", "walnut 1x4", "walnut board", "redwood", "redwood 1x4", "redwood board", "oak", "oak 1x4", "cherry", "cherry 1x4", "birch", "birch 1x4", "poplar", "poplar 1x4"],
    tags: ["lumber", "trim", "shelf", "cedar", "pine", "balsa", "maple", "walnut", "redwood", "oak", "cherry", "birch", "poplar"],
